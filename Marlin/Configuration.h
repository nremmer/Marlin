...
#define STRING_CONFIG_H_AUTHOR "(Nate Emmer, Dec 2020 config)" // Who made the changes.
...
#define LEVEL_BED_CORNERS
  ...
  #define LEVEL_CORNERS_INSET_LFRB { 40, 40, 30, 30 } // (mm) Left, Front, Right, Back insets
